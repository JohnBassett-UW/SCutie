...
#' SCutie
#' performs initial QC of sc data and demultiplexing of experiment cell hashing
#' @param GeX_path
#' @param HTO_path
#'
#'
...
#'
#' @examples
# SCutie <- function(GeX_path, HTO_path = NULL){
#   GeX.counts <- importX(GeX_path)
#   HTO.counts <- importX(HTO_path)
#   sce <- newSC_obj(GeX.counts, HTO.counts)
#   sce <- Attach_QC(sce)
...
# }
#
# classifications <- SCutie(GeX_path = GeX_path, HTO_path = HTO_path)
#
